                                ...
                                <div class="agent-chat-section">
                                    ...
                                    <div class="chat-bottom" id="message_container">
                                        ...
                                        @foreach ($messages as $message)
                                            <div
                                                class="messages @if ($message->from_user === Auth::user()->id) sent
                                        @else
                                        received @endif ">
 
                                                <img src="https://travelquoter.com/assets/img/agents/25.png"
                                                    alt="Agent Name">
                                                ...
                                                @if ($message->file)
                                                    @if (isImage(asset("/uploaded/.$message->file")))
                                                        <img class="message-img"
                                                            src="{{ asset(" /uploaded/.$message->file") }}"
                                                            style="border: none;height: 140px;width: 109px;border-radius: 0px;">
                                                    @else
                                                        <div class="bg-gray-200 px-3 py-1 rounded-md shadow-md">
                                                            <a class="flex items-center"
                                                                href="/uploaded/{{ $message->file }}" target="_blank">
                                                                {{ $message->file }}
                                                                {{-- <img class="ml-2"
                                                                    src="https://img.icons8.com/tiny-color/12/000000/experimental-download-tiny-color.png" /> --}}
                                                            </a>
                                                        </div>
                                                    @endif
                                                @endif
