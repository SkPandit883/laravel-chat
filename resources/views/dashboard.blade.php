                                    ...
                                    <div class="message-outer">
                                        <div class="bg-white p-3 rounded-md w-full mt-3 mb-1 hidden" id="file-container">
                                            <div class="flex items-start">
                                                <img style="height:50px;" class="rounded-lg" src="https://economictimes.indiatimes.com/thumb/msid-89465809,width-1254,height-836,resizemode-4,imgsize-28786/indian-hotels.jpg"
                                                    alt="" id="image">
                                        ...
                                        <div class="message-container p-2">
                                            ...
                                            <input type="file"  name="file" hidden id="file-uploader" onchange="setFile(event)">
